...
#   4. Once merged, rerun \`sudo -E ./create-1password-env-wrapper.sh\`
#      on each host to regenerate this file.
#
# To regenerate locally with the same inputs you used last time, run
# the installer again from the repository root under sudo. The
